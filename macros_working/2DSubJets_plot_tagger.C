...
int plot(TString tagger="CvsL", TString cut="40", int MinEta = 1, int MaxEta = 24, int myNbins = 50, TString Period = "Run2016B",Double_t minAlpha = 0.1, Double_t maxAlpha = 0.3)
{
...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  if( Period == "Run2016" ) //set input and output folder for histogram
  {
    //Lumi = "2.4 fb^{-1}";
    Lumi = "?? fb^{-1} (13 TeV, 25ns)";
    ...
    DataFileRoot = "../Output_jetMass50_fatJet400_data_7p7/Data/JetHT/JetHT_Run2016BC_7p7invfb/JetTree_data_FatJets_Subjets_sampleList_all_NW_";
    MCFileRoot = "../Output_jetMass50_fatJet400_data_7p7/MC/QCD/";
    ...
    //SavDir = "plot_1_Data_MC_Compare_nLepton_gt0_";
    //SavDir = "plot_1_Data_MC_Compare_remove_K0_Lambda_Run2015D_" ;
    SavDir = "plot_1_Data_MC_jetMass50_fatJet400_data_7p7" ;
    SavDir += Period;
  } else return 0;
...
//        h1->SetMaximum(3000000);  
  ...
  TLegend* leg = NULL;
    if( tagger == "CSVv2" ) leg = new TLegend(0.484637,0.631282,0.695531,0.880553);
    else {
